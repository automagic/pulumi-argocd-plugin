...
export class PulumiKubernetesOperator extends pulumi.ComponentResource {
    ...
    constructor(name: string,
        ...
        // Install the CRD
        const stacksCrd = installCRDs(`${name}_stacks`, "https://raw.githubusercontent.com/pulumi/pulumi-kubernetes-operator/master/deploy/crds/pulumi.com_stacks.yaml");
        const programsCrd = installCRDs(`${name}_programs`, "https://raw.githubusercontent.com/pulumi/pulumi-kubernetes-operator/master/deploy/crds/pulumi.com_programs.yaml");
        ...
        }, {dependsOn: [stacksCrd, programsCrd, roleBinding]});
    }
}